 ...
 */
final class Version20220224145051 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE seance ADD films_id INT DEFAULT NULL, ADD create_at DATETIME NOT NULL, ADD film VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE seance DROP films_id, DROP create_at, DROP film, CHANGE langue langue VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
    }
}
